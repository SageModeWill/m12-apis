...
movie.df <- as.data.frame(moive.data)
...
Director <- function(movies) {
  result <- paste0(movies$Title, " was directed by", moives$Director)
  return(result)
}
